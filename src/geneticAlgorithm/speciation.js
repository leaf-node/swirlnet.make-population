...
var currentCompatibilityThreshold, speciesRepresentatives,
    ...
    filterGenomesBySpecies, genomeMaxInnovationNumber,
    getSpeciesList,
...
getNewSpeciesRepresentatives = function (population) {
    ...
    for (species = 0; species <= maxSpeciesID; species += 1) {
        ...
        similarGenomes = filterGenomesBySpecies(population, species);
...
filterGenomesBySpecies = function (population, species) {
...
getSpeciesMemberCount = function (population, species) {
    ...
    memberCount = filterGenomesBySpecies(population, species).length;
...
module.exports.filterGenomesBySpecies = filterGenomesBySpecies;
