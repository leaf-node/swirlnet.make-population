...
insertNewNode = function (genome, upstream, downstream) {
    ...
    console.assert(util.isInt(upstream), "swirljs: internal error: bad upstream node: " + upstream);
    console.assert(util.isInt(downstream), "swirljs: internal error: bad downstream node: " + downstream);
