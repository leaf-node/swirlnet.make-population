...
pickInnovationNumber = function (innovation) {
    ...
    console.assert(innovation[0] === "connection" || innovation[0] === "node",
            "swirljs: internal error: invalid innovation type: " + innovation[0]);

    if (innovation[0] === "connection") {

        console.assert(typeof innovation[1] === "number" && !isNaN(innovation[1]),
                "swirljs: internal error: invalid upstream connection: " + innovation[1]);
        console.assert(typeof innovation[2] === "number" && !isNaN(innovation[2]),
                "swirljs: internal error: invalid downstream connection: " + innovation[2]);
    } else {

        console.assert(innovation[1] === "bias" || innovation[1] === "input" || innovation[1] === "output" || innovation[1] === "hidden",
                "swirljs: internal error: invalid node subtype: " + innovation[1]);
        console.assert(innovation[2] === "sigmoid" || innovation[2] === "linear",
                "swirljs: internal error: invalid node activation function: " + innovation[2]);
        console.assert(innovation[3] === undefined || (typeof innovation[3] === "number" && !isNaN(innovation[3])),
                "swirljs: internal error: invalid node position: " + innovation[3]);
        console.assert(innovation[4] === undefined || (typeof innovation[4] === "number" && !isNaN(innovation[4])),
                "swirljs: internal error: invalid node upstream node: " + innovation[4]);
        console.assert(innovation[5] === undefined || (typeof innovation[5] === "number" && !isNaN(innovation[5])),
                "swirljs: internal error: invalid node downstream node: " + innovation[5]);
    }
...
getNextInnovationNumber = function () {
    ...
    console.assert(nextInnovationNumber !== undefined, "swirljs: internal error: innovations.init() needs to be run!");
...
getInnovationHistory = function () {
    ...
    console.assert(innovationHistory !== undefined, "swirljs: internal error: resetInnovationHistory() needs to be run!");
...
init = function () {
    ...
    console.assert(nextInnovationNumber === undefined, "swirljs: internal error: innovations.init() should only be run once!");
