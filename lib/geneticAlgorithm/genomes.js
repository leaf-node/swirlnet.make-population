...
var genes, util, settings, makeGenome, swirlnetGenomeJSONVersion;

util = require('../util.js');
genes = require('./genes.js');
settings = require('./settings.js');

swirlnetGenomeJSONVersion = "0.0";
...
makeGenome = function (genomeID, generationID, speciesHint) {
    ...
    getNetSettings = function () {
        ...
        netSettings.bias = settings.getSetting("bias");
    ...
    stringify = function () {
        ...
        var genomeObj = {};
        genomeObj.format = "swirlnetGenomeJSON";
        genomeObj.version = swirlnetGenomeJSONVersion;
