...
var genes, makeGenome, swirlGenomeJSONVersion;
...
makeGenome = function (genomeID, generationID, speciesHint) {
    ...
    console.assert(typeof genomeID === "number" && !isNaN(genomeID),
            "swirljs: internal error: invalid genomeID: " + genomeID);
    console.assert(typeof generationID === "number" && !isNaN(generationID),
            "swirljs: internal error: invalid generationID: " + genomeID);
    console.assert(speciesHint === undefined || (typeof speciesHint === "number" && !isNaN(speciesHint)),
    ...
    getGeneInnovationNumbers = function (type, subtype) {
        ...
        Object.keys(genesList).sort().forEach(function (key) {
