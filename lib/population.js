...
makePopulation = function (settings) {

    "use strict";

    var that, defaults,
        init, initSettings, initPopulation,
    ...
    initPopulation = function () {
        ...
        makeFirstGeneration();
        speciate(population, representatives);
    };
    ...
    reproduce = function () {
        ...
        offspringCounts.forEach(function (offspringCount, species) {
            ...
            for (i = 0; i < offspringCount; i += 1) {
                ...
                if (i === 0 && getSpeciesMemberCount(population, species) >= 5) {
    ...
    // makes first generation in the population
    ...
    chooseOffspringCounts = function (population) {
        ...
        population.forEach(function (genome) {
            ...
            adjustedFitness
                ...
                / getSpeciesMemberCount(population, genome.speciesID);
    ...
    getSurvivors = function (population) {
        ...
        speciesList = getSpeciesList(population);
        ...
        speciesList.forEach(function (currentSpeciesCount, species) {
            ...
            speciesMembers = getGenomesInSpecies(population, species);
    ...
    speciate = function (population, representatives) {
    ...
    getGenomes = function () {
        ...
        if (inputCount === undefined || outputCount === undefined) {
            throw new Error('swirljs makePopulation error: you must setInputCount() and setOutputCount() before generating genomes.');
        }
