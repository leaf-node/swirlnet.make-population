...
var growNet, util, swirlnetPhenotypeJSONVersion;

util = require('./util.js');

swirlnetPhenotypeJSONVersion = "0.0";

// converts between swirlnetGenomeJSON and swirlnetPhenotypeJSON
growNet = function (swirlnetGenomeJSON) {
    ...
    genome = JSON.parse(swirlnetGenomeJSON);

    phenotype = {
        "format": "swirlnetPhenotypeJSON",
        "version": swirlnetPhenotypeJSONVersion,
